...
This convolves any consecutive nonparametric distributions contained in
the \<dist_spec\>.
...
to produce the nonparametric components this convolves. The
[`vignette("distspec")`](https://epiforecasts.io/distspec/dev/articles/distspec.md)
...
#>   PMF: [7.5e-12 5.5e-06 0.0026 0.061 0.27 0.37 0.22 0.067 0.013 0.0016 0.00015 1.1e-05 6.6e-07 3.2e-08 1.4e-09 5.2e-11 1.7e-12 4.9e-14 3.3e-15]
