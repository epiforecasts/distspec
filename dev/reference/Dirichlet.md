...
function, used to specify an uncertain
[`NonParametric()`](https://epiforecasts.io/distspec/dev/reference/NonParametric.md)
distribution whose PMF is left uncertain given the Dirichlet prior. Give
either `alpha` directly, or a reference `prior` PMF together with a
`concentration`.
