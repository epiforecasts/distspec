...
- Added
  [`as_dist_spec()`](https://epiforecasts.io/distspec/reference/as_dist_spec.md),
...
- The `cdf_cutoff` argument of
  ...
  and
  [`new_dist_spec()`](https://epiforecasts.io/distspec/reference/new_dist_spec.md)
...
- [`Fixed()`](https://epiforecasts.io/distspec/reference/Fixed.md) now
  forwards its `...` to
  [`bound_dist()`](https://epiforecasts.io/distspec/reference/bound_dist.md)
  as documented; previously limits such as `Fixed(3, max = 5)` were
  silently dropped.
- A non-finite
  [`Fixed()`](https://epiforecasts.io/distspec/reference/Fixed.md) value
  (e.g. `NA` or `Inf`) is now rejected with an informative error;
