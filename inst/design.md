...
The objects can have additional attributes, especially `cdf_max` (the proportion of the cumulative distribution to be represented) and `max` (an absolute maximum).
